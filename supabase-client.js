...
function updateNavAuthUI(session) {
  ...
  if (session) {
    ...
    area.innerHTML = `<button onclick="window.location.href='landing.html'" style="background:var(--accent);color:#000;border:none;padding:5px 14px;font-family:var(--font);font-size:13px;font-weight:700;letter-spacing:1px;cursor:pointer;border-radius:3px">SIGN IN</button>`;
  }
}
